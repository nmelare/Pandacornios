...
class StoryScene5: SKScene {
    ...
    var firstImage: SKSpriteNode = SKSpriteNode(imageNamed: "ilustracao_05")
    ...
    func  firstImageSetUp() {
        ...
        firstImage.size = CGSize(width: UIScreen.main.bounds.width * 1.0, height: UIScreen.main.bounds.height * 0.45)
...
override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
    ...
    if (frontTouchedNode.name == "buttonFoward") {
        let newScene = StoryScene6(size: self.size)
