...
class StoryScene3: SKScene {
    ...
    var firstImage: SKSpriteNode = SKSpriteNode(imageNamed: "ilustracao_03")
    ...
    func  firstImageSetUp() {
        ...
        firstImage.size = CGSize(width: UIScreen.main.bounds.width * 1.3, height: UIScreen.main.bounds.height * 0.52)
